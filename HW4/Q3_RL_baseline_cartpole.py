...
def trial(num_episodes, agent_generator):
    ...
    for episode_idx in range(num_episodes):
        ...
        while True:
            ...
            obs,reward, episode_end,info = env.step(action)
            rewards_sum += reward
...
def example_13_1():
    ...
    # ax.plot(epsilon, true_value(epsilon), color='magenta', marker="o", label="epsilon-greedy ")
    ...
    ax.set_title("Invert pendulum with switched actions")
    ax.set_ylim(ymin=-105.0, ymax=5)
    ax.legend()

    plt.savefig('/home/mengtao/Desktop/example_13_1_invert_pendulum.png')
    # plt.close()
    plt.show()
...
def figure_13_1():
    ...
    plt.savefig('/home/mengtao/Desktop/figure_13_1_invert_pendulum.png')
    plt.close()
    plt.show()
...
def figure_13_2():
    ...
    plt.savefig('/home/mengtao/Desktop/figure_13_2_invert_pendulum.png')
    plt.close()
    plt.show()
